...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="<?= Yii::$app->request->baseUrl;?>/images/single-listing-01.jpg" data-background-image="<?= Yii::$app->request->baseUrl;?>/images/single-listing-01.jpg" class="item mfp-gallery" title="Title 1"></a>
	<a href="<?= Yii::$app->request->baseUrl;?>/images/single-listing-02.jpg" data-background-image="<?= Yii::$app->request->baseUrl;?>/images/single-listing-02.jpg" class="item mfp-gallery" title="Title 3"></a>
	<a href="<?= Yii::$app->request->baseUrl;?>/images/single-listing-03.jpg" data-background-image="<?= Yii::$app->request->baseUrl;?>/images/single-listing-03.jpg" class="item mfp-gallery" title="Title 2"></a>
	<a href="<?= Yii::$app->request->baseUrl;?>/images/single-listing-04.jpg" data-background-image="<?= Yii::$app->request->baseUrl;?>/images/single-listing-04.jpg" class="item mfp-gallery" title="Title 4"></a>
</div>
...
<div class="container">
	<div class="row sticky-wrapper">
			...
			<div id="listing-overview" class="listing-section">
				...
				<div class="listing-links-container">
					...
					<ul class="listing-links contact-links">
						...
						<li><a href="http://www.vasterad.com/cdn-cgi/l/email-protection#5f323e36331f3a273e322f333a713c3032" class="listing-links"><i class="fa fa-envelope-o"></i> <span class="__cf_email__" data-cfemail="127f737b7e52776a737f627e773c717d7f">[email&#160;protected]</span></a>
						</li>
					...
					<ul>
						<li>
							...
							<div class="comment-content"><div class="arrow-comment"></div>
								...
								<div class="review-<?= Yii::$app->request->baseUrl;?>/images mfp-gallery-container">
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<!-- Coupon Widget -->
			<div class="coupon-widget" style="background-image: url(<?= Yii::$app->request->baseUrl;?>/images/single-listing-01.jpg);">
			...
			<div class="boxed-widget margin-top-35">
				<div class="hosted-by-title">
					...
					<a href="pages-user-profile.html" class="hosted-by-avatar"><img src="<?= Yii::$app->request->baseUrl;?>/images/dashboard-avatar.jpg" alt=""></a>
				</div>
				<ul class="listing-details-sidebar">
					<li><i class="sl sl-icon-phone"></i> (123) 123-456</li>
					<!-- <li><i class="sl sl-icon-globe"></i> <a href="#">http://example.com</a></li> -->
					<li><i class="fa fa-envelope-o"></i> <a href="#"><span class="__cf_email__" data-cfemail="abdfc4c6ebced3cac6dbc7ce85c8c4c6">[email&#160;protected]</span></a></li>
				</ul>
